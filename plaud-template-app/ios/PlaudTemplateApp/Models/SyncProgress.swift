...
struct SyncProgress {
    ...
    /// Post-download phase (transcode/decrypt/write). Progress bar holds; UI shows "Converting…"
    /// and no speed, since this is local processing, not transfer (SDK reports it at 100%).
